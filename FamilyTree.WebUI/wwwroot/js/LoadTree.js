window.onload = function () {
    ...
    function LoadFamilyTree() {        
        ...
        if (_familyTrees.length > 0) {
            $.ajax({
                type: 'GET',
                dataType: 'json',
                url: "/FamilyTree/GetFamilyTreeById?id=" + _familyTrees[0].Id + "&personId=" + _familyTrees[0].MainPersonId,
                success: function (result) {
                    console.log(result);
                    mainTree = result;
                    $("#mainPerson")[0].setAttribute("data-value", _familyTrees[0].MainPersonId);
    ...
    function ShowModalPerson(event) {
        ...
        if (bloodFlag) {
            var idPerson = $("#BloodTree")[0].getAttribute("data-value");
        } else {
    ...
    function AddNewPerson(event) {
        ...
        _createPersonData.TreeId = _familyTrees[0].Id;
